...
class Packer(BinaryWriter):
    ...
    def load_image(self, path, pixelFormat):
        if pixelFormat in (0, 1, 2, 3, 4, 6, 10):
            ...
            print('[ERROR] неподерживаемый формат пиксилей ({})! '.format(pixelFormat))
            sys.exit()
    ...
    def pack(self):
        ...
        for image in self.image_list:
            ...
            print('[INFO] {}, ширина: {}, высота: {}, формат пиксиля: {}'.format(ximage, imageHeight, imageWidth, pixelFormat))
        ...
        if len(args.files) == len(args.pixelformat):
            ...
            for file, pixelFormat in zip(args.files, args.pixelformat):
                if file.endswith('.png'):
                    ...
                    print('[ERROR] поддерживаются только пнг изображения!')
                    sys.exit()
